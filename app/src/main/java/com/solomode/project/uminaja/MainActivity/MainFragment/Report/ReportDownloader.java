...
public class ReportDownloader extends AsyncTask<Void,Integer,String> {
    ...
    public ReportDownloader(Context c, String urlAddress, RecyclerView rv) {
        this.c = c;
    ...
    protected void onPostExecute(String data) {
        ...
        if(data != null)
        {
            ReportParser p = new ReportParser(c, data, rv);
            p.execute();
        }else {
